            ...
            <CardContent className={cn(isEditMode && "pt-6")}>
                {isPaid && (
                  <Alert variant="destructive" className="mb-6">
                    ...
                    <AlertDescription>
                      This quotation has payments recorded against it. Financial details (items, prices, client) cannot be edited. You can still update the status or notes.
                    </AlertDescription>
                  </Alert>
                )}
                ...
                <div className="md:col-span-4 grid grid-cols-1 md:grid-cols-3 gap-4 items-center rounded-lg border p-4">
                 ...
                 <div className="space-y-2 md:col-span-4">
                    ...
                    <p className="text-xs text-muted-foreground">Link an existing transaction to this quotation.</p>
                </div>
