...
import type { Quotation, JobSheetStatus as QuotationStatus, PaymentStatus, Operator } from '@/lib/types';
import { jobSheetStatus as quotationStatus, operators } from '@/lib/types';
